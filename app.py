...
# খানা নম্বরের জন্য স্ট্রিমলিট মেমোরি সেটআপ
if 'khana_no_input' not in st.session_state:
    st.session_state.khana_no_input = 1  # শুরুতে ১ নম্বর থেকে শুরু হবে
...
                save_database()
                
                # পরিবর্তন ৪: পপআপ ছাড়া অটোমেটিক পরবর্তী খানা নম্বরে চলে যাওয়া
                try:
